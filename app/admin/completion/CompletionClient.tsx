  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Bounded self-contained scroll box (same max-h-[70vh] overflow-auto
          pattern as ScheduleGrid.tsx/TeachingPracticeManager.tsx/StudentsClient.tsx)
          - the header row's sticky top-0 below sticks to the top of *this*
          box only, never the page, so it can't collide with the admin
          layout's own sticky header. A short filtered result never hits
          max-h, so it never looks boxed-in. */}
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted text-muted-foreground">
              ...
              <th className="sticky top-0 z-10 bg-muted px-4 py-3 text-right font-medium">שעת ביצוע</th>
